...
RSpec.describe Product, type: :model do
  subject { build(:product) } # aqui estamos chamando uma factory que cria produtos. build() não grava o dado no BD, enquanto create() grava.
  ...
  it 'create unfeatured by default' do
